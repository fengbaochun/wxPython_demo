...
class SerialGUI(wx.Frame):
    ...
    def __init__(self,parent):
        ...
        self.SendDatabutton = wx.Button(panel,-1, "发送数据", pos=(100, 510),size=(80,30)) #在面板上添加控件
        self.Bind(wx.EVT_BUTTON, self.SendData_Event, self.SendDatabutton) #将回调函数与按键事件绑定

        self.ClearSendBufferbutton = wx.Button(panel,-1, "清空缓存区", pos=(100, 440),size=(80,30)) #在面板上添加控件
